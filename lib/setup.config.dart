...
import 'package:ut_ad_leika/infrastructure/locations/location_mapper.dart'
    as _i1061;
import 'package:ut_ad_leika/infrastructure/locations/location_repository.dart'
    as _i671;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i638.GeoJsonParser>(() => _i638.GeoJsonParser());
    gh.factory<_i1061.LocationMapper>(() => _i1061.LocationMapper());
    ...
    gh.lazySingleton<_i430.ILocationRepository>(
      () => _i671.LocationRepository(
        gh<_i638.GeoJsonParser>(),
        gh<_i1061.LocationMapper>(),
      ),
    );
    gh.lazySingleton<_i840.ILocationService>(() => _i130.LocationService());
    gh.factory<_i1001.LocationListCubit>(
      () => _i1001.LocationListCubit(
        gh<_i430.ILocationRepository>(),
        gh<_i840.ILocationService>(),
      ),
    );
    gh.factory<_i816.LocationDetailCubit>(
      () => _i816.LocationDetailCubit(
        gh<_i840.ILocationService>(),
        gh<_i430.ILocationRepository>(),
      ),
    );
